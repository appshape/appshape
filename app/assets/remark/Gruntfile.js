...
module.exports = function(grunt) {
  ...
  // Clean task.
  grunt.registerTask('clean-dist', ['clean:css', 'clean:fonts', 'clean:vendor', 'clean:skins']);

  // JS distribution task.
  grunt.registerTask('dev-js', ['jshint', 'concat:components', 'concat:js']);
  grunt.registerTask('dist-js', ['concat:components', 'concat:js', 'uglify:min']);

  // CSS distribution task.
  grunt.registerTask('dev-less', ['csslint', 'less-compile']);
  ...
  grunt.registerTask('dist', ['clean-dist', 'dist-css', 'dist-js', 'dist-vendor', 'dist-skins', 'dist-fonts']);
